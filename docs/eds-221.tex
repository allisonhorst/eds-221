...
miles\strut
\end{minipage} & \begin{minipage}[b]{(\columnwidth - 2\tabcolsep) * \real{0.11}}\raggedright
time\strut
...
\caption{\label{tab:unnamed-chunk-25}Parameter estimates for selected Hawaiian fish from Peyton et al. (2015).}
\centering
